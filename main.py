...
if __name__ == '__main__':
    engine = create_engine('mysql+pymysql://lukas:simplon@localhost/survey_2', echo=False)

    data = pd.read_excel('/home/simplon/Formation_IA/Python/SQLAlchemy/jeu_de_données/Data_Professional_Salary_Survey_Responses_1.xlsx')
    print(data)
